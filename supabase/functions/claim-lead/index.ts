 ...
 * (e.g. both clicking "Claim" off the same alert email) can't both win --
 * whichever UPDATE lands first flips the row, the second one matches zero
 * rows and gets told the lead is already gone. No separate locking needed.
 *
